    ...
    <div class="footer">
      ...
      >
        <svg
          ...
          class="text-[#535353] hover:text-white transition cursor-pointer"
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
          ...
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M16.2471 10.6967C16.2471 13.7384 13.8137 16.1717 10.772 16.1717C7.73025 16.1717 5.29688 13.7384 5.29688 10.646C5.29688 7.65502 7.78094 5.22168 10.8227 5.22168C13.8137 5.22168 16.2471 7.65502 16.2471 10.6967ZM10.7719 14.2453C12.6983 14.2453 14.3205 12.623 14.3205 10.6966C14.3205 8.77025 12.6983 7.14801 10.7719 7.14801C8.79474 7.14801 7.22318 8.77025 7.22318 10.6966C7.17248 12.623 8.79474 14.2453 10.7719 14.2453Z"
            fill="currentColor"
          />
          <path
