...
export const button = tv({
  ...
  variants: {
    size: {
      ...
      xl: "capitalize font-[Outfit] text-[11px] px-[12px] py-[10px] lg:text-[16px] lg:px-[18px] lg:py-[14px] xl:text-[22px] xl:px-[26px] xl:py-[20px]",
      xl2: "capitalize font-[Outfit] text-[11px] px-[14px] py-[10px] lg:text-[16px] lg:px-[22px] lg:py-[14px] xl:text-[22px] xl:px-[30px] xl:py-[20px]",
    },
    fill: { true: "" },
    white: { true: "" },
  },
